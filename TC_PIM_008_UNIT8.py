...
class Login(unittest.TestCase):
    ...
    def test_login(self):
        ...
        driver.find_element(By.XPATH, "(//input[@class='oxd-input oxd-input--active'])[2]").send_keys('gouni')
        driver.find_element(By.XPATH, "//*[@class='oxd-select-text-input']").is_selected()
