...
class Login(unittest.TestCase):
    ...
    def test_login(self):
        ...
        driver.find_element(By.XPATH, "(//input[@class='oxd-input oxd-input--active'])[2]").send_keys('raja')
        driver.find_element(By.XPATH, "(//input[@class='oxd-input oxd-input--active'])[3]").send_keys('best friend')
